...
import cn.com.transcosmos.training.domain.ProjectExample.Criteria;
import cn.com.transcosmos.training.domain.ProjectExample.Criterion;
...
public class ProjectSqlProvider {
	...
	public String insertSelective(Project record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("tbl_project");

		if (record.getProId() != null) {
			sql.VALUES("pro_id", "#{proId,jdbcType=VARCHAR}");
		}
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		...
		if (record.getProId() != null) {
			sql.SET("pro_id = #{record.proId,jdbcType=VARCHAR}");
		}
	...
	public String updateByPrimaryKeySelective(Project record) {
		...
		sql.WHERE("pro_id = #{proId,jdbcType=VARCHAR}");
